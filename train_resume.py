...
if __name__ == '__main__':
     ...
     parser.add_argument("--N_max", type=int, default= 30,  help="During training take at most N_max reverse steps")
     parser.add_argument("--t_eps_min", type=float, default = 0.03,  help="During training take at least N_min reverse steps")
     parser.add_argument("--t_eps_max", type=float, default = 0.85,  help="During training take at most N_max reverse steps")
